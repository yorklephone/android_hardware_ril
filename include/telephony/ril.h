...
typedef enum {
    ...
    RIL_E_QUERY_NETWORK_ABORT = 16,
    RIL_E_QUERY_NETWORK_TIMEOUT = 17,
    RIL_E_QUERY_FORWARD_TIMEOUT = 18,
    RIL_E_SMS_SEND_ACK_TIMEOUT = 19
#else
...
{
  int pin1_retry;
  int  pin1_puk_retry;             /* applicable to USIM and CSIM: RIL_PINSTATE_xxx */
  int           pin2_retry; /* value < RIL_CARD_MAX_APPS */
  int           pin2_puk_retry;     /* value < RIL_CARD_MAX_APPS */
} RIL_AllPinStatus;
#endif
...
#ifdef TARGET_IS_LEPHONE
#define RIL_REQUEST_SET_HEATBEAT_PACKET 104
#define RIL_REQUEST_START_HEATBEAT 105
#define RIL_REQUEST_STOP_HEATBEAT 106
#define RIL_REQUEST_GET_ALL_PIN_STATUS 107
#define RIL_REQUEST_SET_MORE_SMS 108
#define RIL_REQUEST_GET_SIM_CARD_TYPE 109
#define RIL_REQUEST_RADIO_POWER_OFF_WNC 110

#define RIL_REQUEST_DATA_DORMANT_TIME 111

#define RIL_REQUEST_GPRS_ATTACH 112
#endif
/***********************************************************************/
...
#ifdef TARGET_IS_LEPHONE
#define RIL_UNSOL_RESPONSE_NEW_SMS_ON_UIM 1031
#endif
/***********************************************************************/
