...
*/
    ...
    {RIL_REQUEST_SET_HEATBEAT_PACKET, dispatchKlsa, responseVoid},
    {RIL_REQUEST_START_HEATBEAT, dispatchVoid, responseVoid},
    {RIL_REQUEST_STOP_HEATBEAT, dispatchVoid, responseVoid},
    {RIL_REQUEST_GET_ALL_PIN_STATUS, dispatchVoid, responseAllPinStatusCnf},
    {RIL_REQUEST_SET_MORE_SMS, dispatchVoid, responseVoid},
    {RIL_REQUEST_GET_SIM_CARD_TYPE, dispatchVoid, responseSimCardTypeCnf},
    {RIL_REQUEST_RADIO_POWER_OFF_WNC, dispatchVoid, responseVoid},
    {RIL_REQUEST_DATA_DORMANT_TIME, dispatchVoid, responseVoid},
    {RIL_REQUEST_GPRS_ATTACH, dispatchInts, responseVoid}
#else
    {RIL_REQUEST_REPORT_STK_SERVICE_IS_RUNNING, dispatchVoid, responseVoid}
#endif
